            ...
            <div class="col-lg-8">
                ...
                <form method="post" id="formProfileUserDashboard">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="genderUserProfile" id="genderUserProfile" class="form-control" value="<?php echo $fetch['JENIS_KELAMIN'];?>" placeholder="Choose your gender ...." disabled>                    </div>
                    <div class="form-group">
