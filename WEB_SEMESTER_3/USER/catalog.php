<?php 
    ...
    det_laptop.LAMA_GARANSI, det_laptop.stok_detail from laptop inner join det_laptop on laptop.ID_LAPTOP = det_laptop.ID_LAPTOP where det_laptop.STATUS = 1 LIMIT ".$batas_mulai.",".$batas;
    ...
    laptop.RAM, laptop.HARDDISK, laptop.VGA, det_laptop.ID_DET_LAPTOP, det_laptop.HARGA_JUAL, det_laptop.STATUS_GARANSI,
    det_laptop.LAMA_GARANSI, det_laptop.stok_detail from laptop inner join det_laptop on laptop.ID_LAPTOP = det_laptop.ID_LAPTOP where det_laptop.STATUS = 1";
                        ...
                        while($row = mysqli_fetch_assoc($do_query))
                        {
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-16 mb-4">
                                <div class="card h-100">
                                    <a href="">
                                        <img src="../ADMIN/img/<?= $row['GAMBAR_LAPTOP']; ?>" alt="card-img" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h4 class="card-title">
