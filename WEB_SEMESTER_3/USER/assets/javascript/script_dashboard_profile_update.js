...
var genderUser = formUpdate.genderUserProfile;
...
genderUser.onblur = function()
{
    if(isEmpty(genderUser.value))
    {
        ...
        document.getElementById('invalidUpdateGender').innerText = "Harap pilih jenis kelamin.";
    }else
    {
...
formUpdate.addEventListener('submit', function(event){
    ...
    if(isEmpty(namaUser.value) || isEmpty(alamatUser.value) || isEmpty(notelpUser.value) || isEmpty(genderUser.value))
    {
        ...
        event.stopPropagation();
            ...
            || notelpUser.classList.contains('is-invalid') || genderUser.classList.contains('is-invalid'))
    {
        $('#modalWarning').modal('show');
