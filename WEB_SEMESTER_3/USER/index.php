    ...
    <div class="container">
        ...
        <div class="row">
            <?php
                ...
                $query = "select * from laptop inner join det_laptop on laptop.ID_LAPTOP = det_laptop.ID_LAPTOP where det_laptop.STATUS = 1 limit 6";
                            ...
                            ?>
                                <div class="col-lg-4 mb-4">
                                    <div class="card h-100 p-2">
                                        <img src="../ADMIN/img/<?= $row['GAMBAR_LAPTOP']; ?>" alt="Gambar Laptop" class="card-img-top">
                                        <div class="card-body">
